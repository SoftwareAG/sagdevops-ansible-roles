...
REMOTE_S3_BUCKET_SCRIPT_FOLDER="scripts/centrasite"
...
REMOTE_S3_BUCKET_INZIP_LICENSE_PATH="0000563017_CentraSite_ActiveSOA100.xml"
...
REMOTE_S3_BUCKET_PRODUCT_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/Centrasite105Install.script"
...
REMOTE_S3_BUCKET_FIX_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/Centrasite105Update.script"
