...
REMOTE_S3_BUCKET_SCRIPT_FOLDER="scripts/apigateway"
...
REMOTE_S3_BUCKET_PRODUCT_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/APIGW105Install.script"
...
REMOTE_S3_BUCKET_FIX_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/APIGW105Update.script"
