...
REMOTE_S3_BUCKET_SCRIPT_FOLDER="scripts/universalmessaging"
...
REMOTE_S3_BUCKET_INZIP_LICENSE_PATH="0000563007_UniversalMessaging_Integration105.xml"
...
REMOTE_S3_BUCKET_PRODUCT_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/UM105Install.script"
...
REMOTE_S3_BUCKET_FIX_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/UM105Update.script"
