...
REMOTE_S3_BUCKET_SCRIPT_FOLDER="scripts/integration_server"
...
REMOTE_S3_BUCKET_INZIP_LICENSE_PATH="0000563008_Integration_Server100.xml"
...
REMOTE_S3_BUCKET_PRODUCT_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/IS105Install.script"
...
REMOTE_S3_BUCKET_FIX_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/IS105Update.script"
