...
REMOTE_S3_BUCKET_SCRIPT_FOLDER="scripts/apiportal"
...
REMOTE_S3_BUCKET_INZIP_LICENSE_PATH="0000563014_APIPortal101.xml"
...
REMOTE_S3_BUCKET_PRODUCT_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/APIPortal105Install.script"
...
REMOTE_S3_BUCKET_FIX_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/APIPortal105Update.script"
