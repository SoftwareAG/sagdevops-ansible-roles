...
REMOTE_S3_BUCKET_SCRIPT_FOLDER="scripts/apigateway_ids"
...
REMOTE_S3_BUCKET_INZIP_LICENSE_PATH="0000563012_APIGatewayAdvanced104.xml"
LOCAL_LICENSE_PATH="$LOCAL_TARGET_DIR/installer_license.xml"

## products
REMOTE_S3_BUCKET_PRODUCT_IMAGE="LinuxImage105All.zip"
LOCAL_PRODUCT_IMAGE="$LOCAL_TARGET_DIR/installer_image.zip"
REMOTE_S3_BUCKET_PRODUCT_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/APIGWStore105Install.script"
...
REMOTE_S3_BUCKET_FIX_SCRIPT="${REMOTE_S3_BUCKET_SCRIPT_FOLDER}/APIGWStore105Update.script"
